    ...
    <div className="text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32 bg-[#F6F9FC]">
      <div className="flex flex-wrap justify-between gap-12 md:gap-6">
        <div className="max-w-80">
          ...
          />
          <p className="text-sm">
            Discover the world with us. We offer exclusive stays, unique
            experiences, and unforgettable memories. Join our community of
            travelers and explore the best destinations around the globe.
          </p>
