          ...
          <tbody className="text-sm">
            {rooms.map((item, index) => (
              <tr key={index}>
                ...
                <td className="py-3 px-4 text-red-500 text-center text-sm border-t border-gray-300 ">
                  <label className="relative inline-flex items-center cursor-pointer text-gray-900 gap-3">
                    ...
                    <div className="w-12 h-7 bg-slate-300 rounded-full peer-checked:bg-blue-600 transition-colors duration-200 relative">
                      <div
                        className={`absolute top-1 w-5 h-5 bg-white rounded-full transition-all duration-200 ease-in-out
